void connectAWS()
{
  ...
  mqtt_client.subscribe("TeamSwipe_ESP32/return-data");
  mqtt_client.subscribe("TeamSwipe_ESP32/return-employee-pay");
  mqtt_client.subscribe("TeamSwipe_ESP32/return-employee-earned");
  //request Array on startup
